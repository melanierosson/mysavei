...
const ContentAcorns = () => (
    <ul className="acorns need-to-know list">
        <li>
            ...
            <img src={roundupsImg} alt="the total and most recent roundup purchases in the Acorns mobile app" />
        </li>
        <li>
            <p>
            ...
            <img src={recurringImg} alt="Reincurring Investment options screen in Acorns"/>
        </li>
        <li>
            <p>
            ...
            <img src={predictImg} alt="Acorn's Potential Savings Graph feature that can be viewed for every account you setup a reoccurring investment for"/>
        </li>
        <li>
            <p>
            ...
            <img src={laterImg} alt="Later account preview in Acorns"/>
        </li>
        <li>
            ...
            <img src={earlyImg} alt="Early account overview for child named Dax in the Acorns app"/>
        </li>
    </ul>
)
